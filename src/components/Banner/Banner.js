        ...
        <div>
            <div className="container col-lg-12 d-lg-flex py-5 banner">
                <div className="col-lg-5 py-4 ps-2 my-auto">
                    ...
                    <h3>“Travel is  fatal to prejudice, bigotry, and narrow mindedness, and many of our people need it sorely on these accounts.” <span className="text-success"> ~ Mark Twain</span></h3>
                </div>
